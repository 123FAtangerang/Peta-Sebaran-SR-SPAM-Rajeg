...
lyr_Kelurahan_1.set('fieldLabels', {'id': 'no label', 'Nama': 'inline label', 'Dftr Tnggu': 'inline label', 'Target SR': 'inline label', });
lyr_PIPA_2.set('fieldLabels', {'id': 'no label', 'Jenis': 'inline label', 'Diameter': 'inline label', 'Panjang': 'inline label', 'Smber Dana': 'inline label', });
lyr_PipaEksisting_3.set('fieldLabels', {'id': 'no label', 'Jenis': 'inline label', });
lyr_IPACikokol_4.set('fieldLabels', {'id': 'no label', 'Kapasitas': 'inline label', });
